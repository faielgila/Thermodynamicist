...
/// This is an Observable wrapper of <see cref="MixtureSpecies"/> for use in <see cref="PageHomoMixViewModel"/>.
/// </summary>
public partial class ControlMixtureSpeciesViewModel : ObservableObject
{
	/// <summary>
	...
	/// <summary>
	/// Stores the mole fraction of this species in the mixture.
	/// </summary>
	...
	/// <summary>
	/// Stores the phase to model this species in the mixture.
	/// </summary>
	/// No need to explicitly define a public property for this field since
	/// no special logic is needed to change the ViewModel when this value is changed.
	[ObservableProperty]
	private string _modeledPhase;
